  ...
  <div style="width: 100%" class="user-manage">
    <el-form label-width="65px" class="form">
      <el-form-item label="分类名:">
        <el-input v-model="searchParams.name" placeholder="请输入分类名" />
      </el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%" row-style="height:50px" class="table-data" v-loading="loading">
      <el-table-column fixed prop="name" label="分类名" width="100" />
...
import { getSortList, getSortDetail, getModifySort, getAddSort} from '@/api/mode1';
